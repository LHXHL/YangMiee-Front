...
import GogoScanResultsVue from "@/components/Gogo/GogoScanResults.vue";
import GogoScanDetailVue from "@/components/Gogo/GogoScanDetail.vue";
import DashboardPage from "@/components/Dashboard/DashboardPage.vue";
import ToolsContainer from "@/components/Tools/ToolsContainer.vue";
import CryptoTools from "@/components/Tools/CryptoTools.vue";
...
const routes = [
  ...
  {
    path: "/gogo-scan-results",
    name: "GogoScanResults",
    component: GogoScanResultsVue,
  },
  {
    path: "/gogo-scan-detail/:id",
    name: "GogoScanDetail",
    component: GogoScanDetailVue,
    props: true, // 将路由参数作为 props 传递给组件
  },
  {
