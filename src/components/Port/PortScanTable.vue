<template>
  <div class="space-y-6">
    ...
    <div v-if="portScanResults?.length > 0">
        ...
        <table class="w-full">
          ...
          <tbody>
            ...
            >
              ...
              <td class="py-3 px-4 text-sm text-light-text-primary">
                <span
                  class="px-2 py-1 rounded-md bg-purple-500/10 text-purple-600 border border-purple-500/20 inline-flex items-center"
                >
      ...
      <!-- 批量操作工具栏 -->
      <div
        class="flex items-center justify-between flex-wrap gap-4 p-4 rounded-xl border border-light-border bg-light-bg shadow-sm mt-6"
      >
