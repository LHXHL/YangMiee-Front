    ...
    <div class="container mx-auto px-6 py-8 flex-1">
      ...
      >
        ...
        >
          <div class="flex items-center">
            ...
            <div
              ...
              :class="
                filteredResults.length > 0 ? 'bg-blue-500/10 text-blue-600' : ''
              "
            >
          ...
          <div class="flex gap-3">
            ...
            <button
              ...
              class="px-4 py-2.5 rounded-xl text-sm font-medium bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/30 flex items-center justify-center border border-blue-500/30"
            >
        ...
        >
          ...
          >
            <i class="ri-radar-line text-light-text-disabled text-3xl"></i>
          </div>
          ...
          <button
            v-else
            @click="router.push('/task-management')"
            class="px-4 py-2.5 rounded-xl text-sm font-medium bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 transition-all duration-200 flex items-center border border-blue-500/30"
          >
            <i class="ri-add-line mr-2"></i>
            新建扫描任务
          </button>
